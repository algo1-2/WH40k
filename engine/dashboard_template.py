"""
WH40K TACTICAL COMMAND COGITATOR — WEB DASHBOARD TEMPLATE v9.0
        ...
        <div class="panel-body">
          <div class="radar-container-layout">
            ...
            <div class="radar-sidebar">
              <!-- CHAT BRIDGE & QUICK ORDER CONSOLE (ENRICHED PRESETS) -->
              <div class="chat-sync-box">
                ...
                <p style="font-size:0.7rem; color:var(--text-muted); margin:0.35rem 0 0.5rem 0;">
                  Órdenes directas del submundo que desplazan a los agentes y generan el prompt para ChatGPT.
                </p>
        ...
        <div class="panel-body">
          <div class="grid-dashboard" style="grid-template-columns:repeat(auto-fill, minmax(290px, 1fr));">
            ...
            <div class="char-card">
              ...
              <div class="char-status">Estabiliza inmediatamente a pacientes en estado agónico (0 PV).</div>
